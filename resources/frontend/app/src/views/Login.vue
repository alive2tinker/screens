        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow border-0">
                    <div class="card-body">
                        <b-alert show dismissible variant="danger" v-for="(error, index) in errors" :key="index">
                        ...
                        <form>
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-md-5">
                                    <button class="btn btn-primary btn-block" @click="handleLogin" type="button">Login</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<style scoped>
    #background{
        background-image: url("https://sasquatchscreenprinting.com/wp-content/uploads/woods-background.jpg");
        height: 100vh;
    }
</style>
